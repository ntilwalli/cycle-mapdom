...
(0, _tape2.default)("Basic functionality including instantiating VDOM after element is created", function (t) {
  t.equals(typeof _.makeMapDOMDriver === 'undefined' ? 'undefined' : _typeof(_.makeMapDOMDriver), 'function', "should be a function");
  ...
  var outFunc = (0, _.makeMapDOMDriver)(rootEl);
...
(0, _tape2.default)("Allow two map streams at same time and removes anchor from registry when root element removed", function (t) {
  t.equals(typeof _.makeMapDOMDriver === 'undefined' ? 'undefined' : _typeof(_.makeMapDOMDriver), 'function', "should be a function");
...
(0, _tape2.default)("call to select returns a stream and select returns element based on selector", function (t) {
  t.plan(4);
  var rootEl = document.createElement("div");
  ...
  var outFunc = (0, _.makeMapDOMDriver)();
  var outVal = outFunc(map$);
